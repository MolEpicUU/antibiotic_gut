...
# Load packages
  ...
  resmeta <- fread('results/meta_byclass.tsv')
  ...
  load('work/scapis_model.Rdata') # load models 
...
# Create the linear regression function 
  ...
  fwrite(res, file='results/scapis_infobs_byclass.tsv')
  ...
  fwrite(res, file='results/mos_infobs_byclass.tsv')
